        ...
        <div class=" lg:p-12 md:p-10 p-5">
            ...
            <div class="mt-6">
                <div class="text-center font-bold text-white sub-heading">
                    "Chinh phục thị trường bằng trí tuệ và sức mạnh công nghệ, khác biệt là nhân tố dẫn đến sự
                    thành
                    công"<br>
                    Quan niệm làm việc của Truyền thông TD: "Chúng ta đến với nhau bằng ấn tượng ban đầu, ở lại
                    bằng
                    sự yêu mến và niềm tin, và đi với nhau bởi chất lượng cùng với sự tôn trọng."
                </div>
            </div>
